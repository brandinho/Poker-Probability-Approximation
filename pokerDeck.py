...
class pokerDeck():
    def __init__(self):
        ...
        self.players = 2 #I am only making it heads up for now
    ...
    def evaluateHand(self, hand): #I need to output the 5 card hand
        ...
        #Below we check to see if we have a straight flush
        ...
        if straight_flush_sequence < 5 and len(heartsArray) >= 5:
            if len(list(filter(lambda x: x in [2,3,4,5], list(set(hearts_numbers))))) == 4: #I have to implement this for straight flush too (LATER)
                if 14 in hearts_numbers:
                    straight_flush_sequence = 5
                    top5cards = [1,2,3,4,5]
        elif straight_flush_sequence < 5 and len(spadesArray) >= 5:
            if len(list(filter(lambda x: x in [2,3,4,5], list(set(spades_numbers))))) == 4: #I have to implement this for straight flush too (LATER)
                if 14 in spades_numbers:
                    straight_flush_sequence = 5
                    top5cards = [1,2,3,4,5]
        elif straight_flush_sequence < 5 and len(clubsArray) >= 5:
            if len(list(filter(lambda x: x in [2,3,4,5], list(set(clubs_numbers))))) == 4: #I have to implement this for straight flush too (LATER)
                if 14 in clubs_numbers:
                    straight_flush_sequence = 5
                    top5cards = [1,2,3,4,5]
        elif straight_flush_sequence < 5 and len(diamondsArray) >= 5:
            if len(list(filter(lambda x: x in [2,3,4,5], list(set(diamonds_numbers))))) == 4: #I have to implement this for straight flush too (LATER)
        ...
        if straight_flush_sequence >= 5:
            ...
            top5cards = list(range(high_card + 1 - 5, high_card + 1))
        elif len(list(filter(lambda x: x in [2,3,4,5], list(set(numbers))))) == 4: #I have to implement this for straight flush too (LATER)
            if 14 in numbers:
                hand_description = "straight"
                top5cards = [1,2,3,4,5]
            else:                
    ...
    def breakTie(self, top5cards_array):
        #This function currently only supports heads up
        for i in range(5):
